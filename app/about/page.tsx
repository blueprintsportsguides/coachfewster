      ...
      <section className="py-section">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div className="bg-white rounded-card shadow-card p-6 border-l-4 border-primary">
            ...
            <div className="bg-white rounded-card shadow-card p-6 border-l-4 border-primary md:col-span-2">
              <p className="text-lg leading-relaxed text-charcoal-light">
